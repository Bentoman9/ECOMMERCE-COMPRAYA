...
<head>
    ...
    <title>Editar Categoría - COMPRAYA</title>
            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-header bg-dark text-white">
                        <h5 class="mb-0 fw-bold">Editar Categoría</h5>
                    </div>
                    <div class="card-body p-4">
                        <form action="<?= base_url('inventario/categorias/update/' . $categoria['id']); ?>" method="POST">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="descripcion" class="form-control" rows="4"><?= esc($categoria['descripcion']); ?></textarea>
                            </div>
                            <div class="d-flex justify-content-end gap-2">
                                <a href="<?= base_url('inventario/categorias'); ?>" class="btn btn-secondary">Cancelar</a>
                                <button type="submit" class="btn btn-warning fw-bold">Actualizar Categoría</button>
                            </div>
                        </form>
                    </div>
                </div>
